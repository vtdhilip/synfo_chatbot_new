...
import { Client } from '../pages/Index'; // Imports the single source of truth
...
const ClientTable: React.FC<ClientTableProps> = ({ clients, loading, onEdit, onDelete, onToggleStatus, onGetAuthLink }) => {
    ...
    <div className="bg-white rounded-lg shadow-sm overflow-hidden">
      <div className="overflow-x-auto">
        ...
        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Agency</th>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Store/Site</th>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      ...
                      <div className="text-sm text-gray-500">@{client.instagramPageId}</div>
                    </div>
                  </div>
                </td>
                 
                  {userRole === 'admin' && (
      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{client.agencyName}</td>
        )}
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                  {client.platform === 'SHOPIFY' 
                    ? client.shopifyStoreName || 'Not configured'
